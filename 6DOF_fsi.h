...
#ifndef SIXDOF_FSI_H_
#define SIXDOF_FSI_H_

class sixdof_fsi : public sixdof, public gradient
{
public:
    
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW;
	
    sixdof_fsi(lexer*, fdm*, ghostcell*);
	virtual ~sixdof_fsi();
	...
	void ini(lexer*, fdm*, ghostcell*, vector<net*>&);
    void updateFSI(lexer*, fdm*, ghostcell*, bool&);
    void predictor(lexer*, fdm*, ghostcell*,double);
    bool corrector(lexer*, fdm*, ghostcell*,double,vrans*, vector<net*>&);
    void finalise(lexer*, fdm*, ghostcell*,double);
	void forces_stl(lexer*, fdm*, ghostcell*,double,double,double,double,double,double,double);
