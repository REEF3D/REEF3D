...
void sixdof_fsi::externalForces(lexer *p,fdm* a, ghostcell *pgc, double alpha, vrans *pvrans, vector<net*>& pnet)
{
...
void sixdof_fsi::mooringForces(lexer *p, fdm* a, ghostcell *pgc, double alpha)
{
...
void sixdof_fsi::netForces(lexer *p, fdm* a, ghostcell *pgc, double alpha, vrans *pvrans, vector<net*>& pnet)
{
...
void sixdof_fsi::updateForces(fdm *a)
{
