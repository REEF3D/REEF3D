...
void sixdof_fsi::geometry(lexer *p, fdm *a, ghostcell *pgc)
{
...
void sixdof_fsi::geometry_f(double& w0, double& w1, double& w2, double& f1, double& f2, double& f3, double& g0, double& g1, double& g2)
{
	double temp0 = w0 + w1;
    f1 = temp0 + w2;
    double temp1 = w0 * w0;
...
void sixdof_fsi::geometry_ls(lexer *p, fdm *a, ghostcell *pgc)
{
	// Total Volume
	double Rfb, H;
	double Vfb=0.0;
