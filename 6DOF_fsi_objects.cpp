...
void sixdof_fsi::objects(lexer *p, fdm *a, ghostcell *pgc)
{
    int qn;
...
void sixdof_fsi::objects_allocate(lexer *p, fdm *a, ghostcell *pgc)
{
...
void sixdof_fsi::geometry_refinement(lexer *p)
{
...
void sixdof_fsi::create_triangle
(
