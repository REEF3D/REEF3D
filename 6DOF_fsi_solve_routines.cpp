...
void sixdof_fsi::rk3(lexer *p, fdm *a, ghostcell *pgc, double alpha)
{
    if (alpha == 1.0)
    {
        pk_ = p_;
...
void sixdof_fsi::rk4(lexer *p, fdm *a, ghostcell *pgc, double alpha)
{
    get_trans(p,a,pgc, dp_, dc_, p_, c_);    
    get_rot(dh_, de_, h_, e_);
...
Eigen::Vector3d sixdof_fsi::ab4_3
(
    lexer *p,
...
Eigen::MatrixXd sixdof_fsi::ab4_matrix
(
    lexer *p,
...
Eigen::Vector4d sixdof_fsi::ab4_4
(
    lexer *p,
...
Eigen::Vector3d sixdof_fsi::am4_3
(
    lexer *p,
...
Eigen::Vector4d sixdof_fsi::am4_4
(
    lexer *p,
