...
void sixdof_fsi::updateFSI(lexer *p, fdm *a, ghostcell* pgc, bool& converged)
{
    // Print quaternion
...
void sixdof_fsi::updatePosition(lexer *p, fdm *a, ghostcell *pgc, bool converged)
{
...
void sixdof_fsi::finalise(lexer *p, fdm *a, ghostcell *pgc, double alpha)
{
    // Store RBM motion
...
void sixdof_fsi::quat_matrices(const Eigen::Vector4d& e)
{
    E_ << -e(1), e(0), -e(3), e(2),
         -e(2), e(3), e(0), -e(1),
         -e(3), -e(2), e(1), e(0); 
...
double sixdof_fsi::Hsolidface(lexer *p, fdm *a, int aa, int bb, int cc)
{
