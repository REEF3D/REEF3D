...
void sixdof_f::geometry_ini(lexer *p, fdm *a, ghostcell *pgc)
{
...
void sixdof_f::geometry_ini_f(double& w0, double& w1, double& w2, double& f1, double& f2, double& f3, double& g0, double& g1, double& g2)
{
	double temp0 = w0 + w1;
    f1 = temp0 + w2;
    double temp1 = w0 * w0;
...
void sixdof_f::center_gravity(lexer *p, fdm *a, ghostcell *pgc)
{
	// Total Volume
	Vfb=0.0;
	ALOOP
...
void sixdof_f::moments_inertia(lexer *p, fdm *a, ghostcell *pgc)
{
// Moments of Inertia
