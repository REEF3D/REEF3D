...
void sixdof_f::objects(lexer *p, fdm *a, ghostcell *pgc)
{
    int qn;
...
void sixdof_f::objects_allocate(lexer *p, fdm *a, ghostcell *pgc)
{
...
void sixdof_f::geometry_refinement(lexer *p)
{
