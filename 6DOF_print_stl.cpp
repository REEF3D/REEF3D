...
void sixdof_f::print_stl(lexer *p, fdm *a, ghostcell *pgc)
{
	int num=0;
...
if(p->mpirank==0 && (((p->count%p->P20==0) && p->P30<0.0)  || (p->simtime>printtime && p->P30>0.0)   || p->count==0))
{
	...
	{
		if(num<10)
		sprintf(name,"./REEF3D_6DOF_STL/REEF3D-6DOF-00000%d.stl",num);

		if(num<100&&num>9)
		sprintf(name,"./REEF3D_6DOF_STL/REEF3D-6DOF-0000%d.stl",num);

		if(num<1000&&num>99)
		sprintf(name,"./REEF3D_6DOF_STL/REEF3D-6DOF-000%d.stl",num);

		if(num<10000&&num>999)
		sprintf(name,"./REEF3D_6DOF_STL/REEF3D-6DOF-00%d.stl",num);

		if(num<100000&&num>9999)
		sprintf(name,"./REEF3D_6DOF_STL/REEF3D-6DOF-0%d.stl",num);

		if(num>99999)
		sprintf(name,"./REEF3D_6DOF_STL/REEF3D-6DOF-%d.stl",num);
	}
