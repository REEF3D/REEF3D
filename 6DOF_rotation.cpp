...
void sixdof_f::rotation(double &p,double &q,double &r,double phi, double theta, double psi)
{
	double a,b,c;
...
void sixdof_f::rotation_quaternion(double &p,double &q,double &r,double phi, double theta, double psi)
{
	double a,b,c;
...
std::vector<double> sixdof_f::rotation_R
(
