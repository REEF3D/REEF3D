...
void sixdof_f::transform_vec_SE(double xvec,double yvec,double zvec,double &xout,double &yout,double &zout)
{
...
void sixdof_f::transform_angle_ES(double alpha,double beta,double gamma,double &alpha_out,double &beta_out,double &gamma_out)
{
...
void sixdof_f::transform_angle_SE(double alpha,double beta,double gamma,double &alpha_out,double &beta_out,double &gamma_out)
{
