...
#ifndef BC_KEPSILON_H_
#define BC_KEPSILON_H_

using namespace std;

class bc_kepsilon : private increment, public roughness
{
public:
	bc_kepsilon(lexer*);
	virtual ~bc_kepsilon();
	...
	void wall_law_eps(fdm*,lexer*,field&,field&,int,int,int,int,int,double);
