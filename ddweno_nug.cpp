...
double ddweno_nug::ddwenox(fdm* a, vec& b, double uw, cpt &C)
{
    DX = p->DXP;
    DY = p->DYP;
    DZ = p->DZP;
...
double ddweno_nug::ddwenoy(fdm* a, vec& b, double uw, cpt &C)
{
    DX = p->DXP;
    DY = p->DYP;
    DZ = p->DZP;
...
double ddweno_nug::ddwenoz(fdm* a, vec& b, double uw, cpt &C)
{
    DX = p->DXP;
    DY = p->DYP;
    DZ = p->DZP;
