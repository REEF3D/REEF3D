...
density_rheology::density_rheology(lexer* p) : epsi(p->F45*p->dx), eps(2.1*p->dx)
{
}

density_rheology::~density_rheology()
{
}

double density_rheology::roface(lexer *p, fdm *a, int aa, int bb, int cc)
{
    double psi,r,s;
