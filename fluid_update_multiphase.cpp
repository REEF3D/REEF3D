...
fluid_update_multiphase::fluid_update_multiphase(lexer *p, fdm* a, ghostcell* pgc) : dx(p->dx),
...
fluid_update_multiphase::~fluid_update_multiphase()
{
}

void fluid_update_multiphase::start3(lexer *p, fdm* a, ghostcell* pgc, field &ls1, field &ls2)
{
	double H1=0.0;
	double H2=0.0;
	double H3=0.0;
...
void fluid_update_multiphase::start(lexer *p, fdm* a, ghostcell* pgc)
{
}

int fluid_update_multiphase::iocheck;
int fluid_update_multiphase::iter;
