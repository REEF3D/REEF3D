...
fnpf_laplace_cds2_v3::fnpf_laplace_cds2_v3(lexer *p) 
{
...
fnpf_laplace_cds2_v3::~fnpf_laplace_cds2_v3()
{
}


void fnpf_laplace_cds2_v3::start(lexer* p, fdm_fnpf *c, ghostcell *pgc, solver *psolv, fnpf_fsf *pf, double *f)
{
    // see p. 1130-1132
    double sigxyz2;
