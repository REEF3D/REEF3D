...
fnpf_sg_laplace_HOS::fnpf_sg_laplace_HOS(lexer *p) 
{
    pbed = new fnpf_sg_bed_update(p);
}

fnpf_sg_laplace_HOS::~fnpf_sg_laplace_HOS()
{
}

void fnpf_sg_laplace_HOS::start(lexer* p, fdm_fnpf *c, ghostcell *pgc, solver *psolv,fnpf_sg_fsf *pf, double *f)
{
    double sigxyz2;
    double ab,denom;
