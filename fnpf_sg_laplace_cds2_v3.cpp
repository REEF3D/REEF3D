...
#include"fnpf_sg_laplace_cds2_v3.h"
#include"lexer.h"
#include"fdm_fnpf.h"
#include"solver.h"
#include"ghostcell.h"
...
fnpf_sg_laplace_cds2_v3::fnpf_sg_laplace_cds2_v3(lexer *p) 
{
...
fnpf_sg_laplace_cds2_v3::~fnpf_sg_laplace_cds2_v3()
{
}


void fnpf_sg_laplace_cds2_v3::start(lexer* p, fdm_fnpf *c, ghostcell *pgc, solver *psolv, fnpf_sg_fsf *pf, double *f)
{
    // see p. 1130-1132
    double sigxyz2;
