...
fnpf_sg_laplace_cds4_bc2::fnpf_sg_laplace_cds4_bc2(lexer *p) 
{
...
fnpf_sg_laplace_cds4_bc2::~fnpf_sg_laplace_cds4_bc2()
{
}


void fnpf_sg_laplace_cds4_bc2::start(lexer* p, fdm_fnpf *c, ghostcell *pgc, solver *psolv, fnpf_sg_fsf *pf, double *f)
{
    // see p. 1130-1132
    ...
    psolv->startF(p,c,pgc,f,c->rhsvec,c->M,10,p->N46,p->N44);
