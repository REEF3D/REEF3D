...
// Store extragcb in gcb vec	
    ...
    WLOOP
    {
        ...
        if(p->flag3[WIm1JK]==TOPO)
        p->gcb3[count][4]=5;

        if(p->flag3[WIm1JK]==OBJ)
        p->gcb3[count][4]=21;
        
        if(p->flag3[WIm1JK]==SOLID)
        p->gcb3[count][4]=22;
		
		if(p->flag3[WIm1JK]==FLT)
        p->gcb3[count][4]=41;
        ++count;
        }
        ...
        if(p->flag3[WIJm1K]==TOPO)
        p->gcb3[count][4]=5;

        if(p->flag3[WIJm1K]==OBJ)
        p->gcb3[count][4]=21;
        
        if(p->flag3[WIJm1K]==SOLID)
        p->gcb3[count][4]=22;
		
		if(p->flag3[WIJm1K]==FLT)
        p->gcb3[count][4]=41;
        ++count;
        }
        ...
        if(p->flag3[WIJp1K]==TOPO)
        p->gcb3[count][4]=5;

        if(p->flag3[WIJp1K]==OBJ)
        p->gcb3[count][4]=21;
        
        if(p->flag3[WIJm1K]==SOLID)
        p->gcb3[count][4]=22;
		
		if(p->flag3[WIJp1K]==FLT)
        p->gcb3[count][4]=41;
        ++count;
        }
        ...
        if(p->flag3[WIp1JK]==TOPO)
        p->gcb3[count][4]=5;

        if(p->flag3[WIp1JK]==OBJ)
        p->gcb3[count][4]=21;
        
        if(p->flag3[WIp1JK]==SOLID)
        p->gcb3[count][4]=22;
		
		if(p->flag3[WIp1JK]==FLT)
        p->gcb3[count][4]=41;
        ++count;
        }
        ...
        if(p->flag3[WIJKm1]==TOPO)
        p->gcb3[count][4]=5;

        if(p->flag3[WIJKm1]==OBJ)
        p->gcb3[count][4]=21;
        
        if(p->flag3[WIJKm1]==SOLID)
        p->gcb3[count][4]=22;
		
		if(p->flag3[WIJKm1]==FLT)
        p->gcb3[count][4]=41;
        ++count;
        }
        ...
        if(p->flag3[WIJKp1]==TOPO)
        p->gcb3[count][4]=5;

        if(p->flag3[WIJKp1]==OBJ)
        p->gcb3[count][4]=21;
        
        if(p->flag3[WIJKp1]==SOLID)
        p->gcb3[count][4]=22;

        if(p->flag3[WIJKp1]==FLT)
        p->gcb3[count][4]=41;
        ++count;
        }
    }
