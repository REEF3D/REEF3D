...
#define Ip1_J_K_1 aa->C1.n[n]
#define Im1_J_K_1 aa->C1.s[n]
#define I_Jp1_K_1 aa->C1.w[n]
#define I_Jm1_K_1 aa->C1.e[n]
#define I_J_Kp1_1 aa->C1.t[n]
#define I_J_Km1_1 aa->C1.b[n]

#define Ip2_J_K_1 aa->C1.n[aa->C1.n[n]]
#define Im2_J_K_1 aa->C1.s[aa->C1.s[n]]
#define I_Jp2_K_1 aa->C1.w[aa->C1.w[n]]
#define I_Jm2_K_1 aa->C1.e[aa->C1.e[n]]
#define I_J_Kp2_1 aa->C1.t[aa->C1.t[n]]
#define I_J_Km2_1 aa->C1.b[aa->C1.b[n]]

#define Ip3_J_K_1 aa->C1.n[aa->C1.n[aa->C1.n[n]]]
#define Im3_J_K_1 aa->C1.s[aa->C1.s[aa->C1.s[n]]]
#define I_Jp3_K_1 aa->C1.w[aa->C1.w[aa->C1.w[n]]]
#define I_Jm3_K_1 aa->C1.e[aa->C1.e[aa->C1.e[n]]]
#define I_J_Kp3_1 aa->C1.t[aa->C1.t[aa->C1.t[n]]]
#define I_J_Km3_1 aa->C1.b[aa->C1.b[aa->C1.b[n]]]

#define Ip1_Jp1_K_1 aa->C1.n[aa->C1.w[n]]
#define Ip1_J_Kp1_1 aa->C1.n[aa->C1.t[n]]
#define Ip1_Jm1_K_1 aa->C1.n[aa->C1.e[n]]
#define Ip1_J_Km1_1 aa->C1.n[aa->C1.b[n]]
#define Im1_Jp1_K_1 aa->C1.s[aa->C1.w[n]]
#define Im1_J_Kp1_1 aa->C1.s[aa->C1.t[n]]
#define Im1_Jm1_K_1 aa->C1.s[aa->C1.e[n]]
#define Im1_J_Km1_1 aa->C1.s[aa->C1.b[n]]
#define I_Jp1_Kp1_1 aa->C1.w[aa->C1.t[n]]
#define I_Jp1_Km1_1 aa->C1.w[aa->C1.b[n]]
#define I_Jm1_Kp1_1 aa->C1.e[aa->C1.t[n]]
#define I_Jm1_Km1_1 aa->C1.e[aa->C1.b[n]]

// 2 ----------------------------------------------

#define Ip1_J_K_2 aa->C2.n[n]
#define Im1_J_K_2 aa->C2.s[n]
#define I_Jp1_K_2 aa->C2.w[n]
#define I_Jm1_K_2 aa->C2.e[n]
#define I_J_Kp1_2 aa->C2.t[n]
#define I_J_Km1_2 aa->C2.b[n]

#define Ip2_J_K_2 aa->C2.n[aa->C2.n[n]]
#define Im2_J_K_2 aa->C2.s[aa->C2.s[n]]
#define I_Jp2_K_2 aa->C2.w[aa->C2.w[n]]
#define I_Jm2_K_2 aa->C2.e[aa->C2.e[n]]
#define I_J_Kp2_2 aa->C2.t[aa->C2.t[n]]
#define I_J_Km2_2 aa->C2.b[aa->C2.b[n]]

#define Ip3_J_K_2 aa->C2.n[aa->C2.n[aa->C2.n[n]]]
#define Im3_J_K_2 aa->C2.s[aa->C2.s[aa->C2.s[n]]]
#define I_Jp3_K_2 aa->C2.w[aa->C2.w[aa->C2.w[n]]]
#define I_Jm3_K_2 aa->C2.e[aa->C2.e[aa->C2.e[n]]]
#define I_J_Kp3_2 aa->C2.t[aa->C2.t[aa->C2.t[n]]]
#define I_J_Km3_2 aa->C2.b[aa->C2.b[aa->C2.b[n]]]

#define Ip1_Jp1_K_2 aa->C2.n[aa->C2.w[n]]
#define Ip1_J_Kp1_2 aa->C2.n[aa->C2.t[n]]
#define Ip1_Jm1_K_2 aa->C2.n[aa->C2.e[n]]
#define Ip1_J_Km1_2 aa->C2.n[aa->C2.b[n]]
#define Im1_Jp1_K_2 aa->C2.s[aa->C2.w[n]]
#define Im1_J_Kp1_2 aa->C2.s[aa->C2.t[n]]
#define Im1_Jm1_K_2 aa->C2.s[aa->C2.e[n]]
#define Im1_J_Km1_2 aa->C2.s[aa->C2.b[n]]
#define I_Jp1_Kp1_2 aa->C2.w[aa->C2.t[n]]
#define I_Jp1_Km1_2 aa->C2.w[aa->C2.b[n]]
#define I_Jm1_Kp1_2 aa->C2.e[aa->C2.t[n]]
#define I_Jm1_Km1_2 aa->C2.e[aa->C2.b[n]]

// 3 ----------------------------------------------

#define Ip1_J_K_3 aa->C3.n[n]
#define Im1_J_K_3 aa->C3.s[n]
#define I_Jp1_K_3 aa->C3.w[n]
#define I_Jm1_K_3 aa->C3.e[n]
#define I_J_Kp1_3 aa->C3.t[n]
#define I_J_Km1_3 aa->C3.b[n]

#define Ip2_J_K_3 aa->C3.n[aa->C3.n[n]]
#define Im2_J_K_3 aa->C3.s[aa->C3.s[n]]
#define I_Jp2_K_3 aa->C3.w[aa->C3.w[n]]
#define I_Jm2_K_3 aa->C3.e[aa->C3.e[n]]
#define I_J_Kp2_3 aa->C3.t[aa->C3.t[n]]
#define I_J_Km2_3 aa->C3.b[aa->C3.b[n]]

#define Ip3_J_K_3 aa->C3.n[aa->C3.n[aa->C3.n[n]]]
#define Im3_J_K_3 aa->C3.s[aa->C3.s[aa->C3.s[n]]]
#define I_Jp3_K_3 aa->C3.w[aa->C3.w[aa->C3.w[n]]]
#define I_Jm3_K_3 aa->C3.e[aa->C3.e[aa->C3.e[n]]]
#define I_J_Kp3_3 aa->C3.t[aa->C3.t[aa->C3.t[n]]]
#define I_J_Km3_3 aa->C3.b[aa->C3.b[aa->C3.b[n]]]

#define Ip1_Jp1_K_3 aa->C3.n[aa->C3.w[n]]
#define Ip1_J_Kp1_3 aa->C3.n[aa->C3.t[n]]
#define Ip1_Jm1_K_3 aa->C3.n[aa->C3.e[n]]
#define Ip1_J_Km1_3 aa->C3.n[aa->C3.b[n]]
#define Im1_Jp1_K_3 aa->C3.s[aa->C3.w[n]]
#define Im1_J_Kp1_3 aa->C3.s[aa->C3.t[n]]
#define Im1_Jm1_K_3 aa->C3.s[aa->C3.e[n]]
#define Im1_J_Km1_3 aa->C3.s[aa->C3.b[n]]
#define I_Jp1_Kp1_3 aa->C3.w[aa->C3.t[n]]
#define I_Jp1_Km1_3 aa->C3.w[aa->C3.b[n]]
#define I_Jm1_Kp1_3 aa->C3.e[aa->C3.t[n]]
#define I_Jm1_Km1_3 aa->C3.e[aa->C3.b[n]]
