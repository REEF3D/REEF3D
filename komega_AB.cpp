...
//omega
	...
	LOOP
	{
	eps(i,j,k)+=p->dt*0.5*(((p->turbtimestep+2.0*p->turbtimestep_old)/p->dt_old)*a->L(i,j,k)
...
void komega_AB::ktimesave(lexer *p, fdm* a, ghostcell *pgc)
{
}

void komega_AB::etimesave(lexer *p, fdm* a, ghostcell *pgc)
{
}
