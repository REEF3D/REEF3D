...
// Step 1
    ...
    bckeps_start(a,p,kin,brk1,gcval_eps);
...
// Step 2
	...
	pdiff->idiff_scalar(p,a,pgc,psolv,ark2,a->visc,kw_sigma_k,0.25);
	...
	pdiff->idiff_scalar(p,a,pgc,psolv,brk2,a->visc,kw_sigma_w,0.25);
	epsfsf(p,a,pgc,kin,eps);
    bckeps_start(a,p,kin,brk2,gcval_eps);
...
// Step 3
	...
	pdiff->idiff_scalar(p,a,pgc,psolv,kin,a->visc,kw_sigma_k,2.0/3.0);
	...
	pdiff->idiff_scalar(p,a,pgc,psolv,eps,a->visc,kw_sigma_w,2.0/3.0);
	epsfsf(p,a,pgc,kin,eps);
...
void komega_RK3::ktimesave(lexer *p, fdm* a, ghostcell *pgc)
{
}

void komega_RK3::etimesave(lexer *p, fdm* a, ghostcell *pgc)
{
}
