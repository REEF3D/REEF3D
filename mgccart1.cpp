...
//PARA2
    ...
    k=p->gcpara1[q][2];
		...
		&& p->mgc1[(i-imin+n+1)*jmax*kmax + (j-jmin)*kmax + k-kmin]<10)
        {
			p->mgc1[(i-imin+n+1)*jmax*kmax + (j-jmin)*kmax + k-kmin]=p->gcextra1;
			++p->gcextra1;
        }
    }
    ...
    k=p->gcpara3[q][2];
		...
		&& p->mgc1[(i-imin)*jmax*kmax + (j-jmin+n+1)*kmax + k-kmin]<10)
        {
			p->mgc1[(i-imin)*jmax*kmax + (j-jmin+n+1)*kmax + k-kmin]=p->gcextra1;
			++p->gcextra1;
        }
    }
    ...
    k=p->gcpara5[q][2]+1;
		...
		&& p->mgc1[(i-imin)*jmax*kmax + (j-jmin)*kmax + k-kmin+n+1]<10)
        {
			p->mgc1[(i-imin)*jmax*kmax + (j-jmin)*kmax + k-kmin+n+1]=p->gcextra1;
			++p->gcextra1;
        }
	}
