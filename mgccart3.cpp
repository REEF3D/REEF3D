...
//WALL2
    ...
    k=p->gcpara1[q][2];
		...
		&& p->mgc3[(i-imin+n+1)*jmax*kmax + (j-jmin)*kmax + k-kmin]<10)
        {
			p->mgc3[(i-imin+n+1)*jmax*kmax + (j-jmin)*kmax + k-kmin]=p->gcextra3;
			++p->gcextra3;
        }
    }
    ...
    k=p->gcpara3[q][2];
		...
		&& p->mgc3[(i-imin)*jmax*kmax + (j-jmin+n+1)*kmax + k-kmin]<10)
        {
			p->mgc3[(i-imin)*jmax*kmax + (j-jmin+n+1)*kmax + k-kmin]=p->gcextra3;
			++p->gcextra3;
        }
    }
    ...
    k=p->gcpara5[q][2]+1;
		...
		&& p->mgc3[(i-imin)*jmax*kmax + (j-jmin)*kmax + k-kmin+n+1]<10)
        {
			p->mgc3[(i-imin)*jmax*kmax + (j-jmin)*kmax + k-kmin+n+1]=p->gcextra3;
			++p->gcextra3;
        }
	}
