...
#ifndef MOMENTUM_FS4_H_
#define MOMENTUM_FS4_H_

class momentum_FS4 : public momentum, public bcmom
{
public:
	momentum_FS4(lexer*, fdm*, convection*, diffusion*, pressure*, poisson*, turbulence*, solver*, solver*, ioflow*);
	virtual ~momentum_FS4();
