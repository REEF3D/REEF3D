...
momentum_MK3::momentum_MK3(lexer *p, fdm *a, discrete *pdiscrete, diffusion *pdiffusion, pressure* ppressure, poisson* ppoisson,
...
momentum_MK3::~momentum_MK3()
{
}

void momentum_MK3::start(lexer *p, fdm* a, ghostcell* pgc, momentum *pmom)
{
...
void momentum_MK3::irhs(lexer *p, fdm *a)
{
	n=0;
	if(p->D20<3)
	ULOOP
...
void momentum_MK3::jrhs(lexer *p, fdm *a)
{
	n=0;
	if(p->D20<3)
	VLOOP
...
void momentum_MK3::krhs(lexer *p, fdm *a)
{
	n=0;
	if(p->D20<3)
	WLOOP
...
void momentum_MK3::utimesave(lexer *p, fdm *a, ghostcell *pgc)
{
}

void momentum_MK3::vtimesave(lexer *p, fdm *a, ghostcell *pgc)
{
}

void momentum_MK3::wtimesave(lexer *p, fdm *a, ghostcell *pgc)
{
}

void momentum_MK3::fillaij1(lexer *p, fdm *a, ghostcell* pgc, solver *psolv)
{
}

void momentum_MK3::fillaij2(lexer *p, fdm *a, ghostcell* pgc, solver *psolv)
{
}

void momentum_MK3::fillaij3(lexer *p, fdm *a, ghostcell* pgc, solver *psolv)
{
}
