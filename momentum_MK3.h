...
#ifndef MOMENTUM_MK3_H_
#define MOMENTUM_MK3_H_

class momentum_MK3 : public momentum, public bcmom
{
public:
	momentum_MK3(lexer*, fdm*, convection*, diffusion*, pressure*, poisson*, turbulence*, solver*, solver*, ioflow*);
	virtual ~momentum_MK3();
