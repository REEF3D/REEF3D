...
#ifndef MOMENTUM_RK4_H_
#define MOMENTUM_RK4_H_

class momentum_RK4 : public momentum, public bcmom
{
public:
	momentum_RK4(lexer*, fdm*, discrete*, diffusion*, pressure*, poisson*, turbulence*, solver*, solver*, ioflow*);
