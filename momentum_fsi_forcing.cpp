...
void momentum_fsi::forcing(lexer* p, fdm* a, ghostcell* pgc, sixdof_fsi* p6dof_fsi, field& uvel, field& vvel, field& wvel, field& uveln, field& vveln, field& wveln, double alpha, vrans* pvrans, vector<net*>& pnet)
{
    ...
    bool conv = true;
    forces(p ,a, pgc, p6dof_fsi, uveln, vveln, wveln, conv, alpha);
    p6dof_fsi->corrector(p,a,pgc,alpha,pvrans,pnet);
    ...
    p6dof_fsi->saveTimeStep(p,alpha);
    p6dof_fsi->interface(p,true);
}


void momentum_fsi::forces(lexer* p, fdm* a, ghostcell* pgc, sixdof_fsi* p6dof,field& uveln, field& vveln, field& wveln, bool converged, double alpha)
{
    double fn, dm;
