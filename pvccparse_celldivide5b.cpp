...
void pvccparse::cell_divide5b(lexer* p, fdm* a, ghostcell *pgc)
{
        // cell 1
        if(pt[1]==1 && pt[4]==1 && pt[5]==1 && pt[6]==1 && pt[7]==1
        && cl[0]<=0 && cl[1]<=0 && cl[4]<=0 && cl[6]<=0 && cl[7]<=0)
        {
        ...
        && cl[1]<=0 && cl[2]<=0 && cl[4]<=0 && cl[5]<=0 && cl[7]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XN[IP1];
        ...
        && cl[3]<=0 && cl[4]<=0 && cl[4]<=0 && cl[5]<=0 && cl[6]<=0)
        {
        ...
        && cl[0]<=0 && cl[3]<=0 && cl[5]<=0 && cl[6]<=0 && cl[7]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XN[IP];
        p->ccpoint[p->ccptnum][1]=p->YN[JP];
        p->ccpoint[p->ccptnum][2]=p->ZP[KP];
        ...
        && cl[0]<=0 && cl[5]<=0 && cl[3]<=0 && cl[11]<=0 && cl[9]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XN[IP1];
        ...
        && cl[0]<=0 && cl[4]<=0 && cl[1]<=0 && cl[11]<=0 && cl[9]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XN[IP];
        p->ccpoint[p->ccptnum][1]=p->YP[JP];
        p->ccpoint[p->ccptnum][2]=p->ZN[KP];
        ...
        && cl[4]<=0 && cl[8]<=0 && cl[1]<=0 && cl[3]<=0 && cl[9]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XN[IP];
        p->ccpoint[p->ccptnum][1]=p->YP[JP];
        ...
        && cl[5]<=0 && cl[8]<=0 && cl[1]<=0 && cl[3]<=0 && cl[11]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XN[IP1];
        p->ccpoint[p->ccptnum][1]=p->YP[JP];
        p->ccpoint[p->ccptnum][2]=p->ZN[KP1];
        ...
        && cl[3]<=0 && cl[7]<=0 && cl[0]<=0 && cl[8]<=0 && cl[10]<=0)
        {
        ...
        && cl[4]<=0 && cl[11]<=0 && cl[0]<=0 && cl[2]<=0 && cl[10]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XP[IP];
        p->ccpoint[p->ccptnum][1]=p->YN[JP];
        p->ccpoint[p->ccptnum][2]=p->ZN[KP1];
        ...
        && cl[3]<=0 && cl[4]<=0 && cl[2]<=0 && cl[8]<=0 && cl[10]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XP[IP];
        p->ccpoint[p->ccptnum][1]=p->YN[JP];
        p->ccpoint[p->ccptnum][2]=p->ZN[KP];
        ...
        && cl[7]<=0 && cl[11]<=0 && cl[0]<=0 && cl[2]<=0 && cl[8]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XP[IP];
        p->ccpoint[p->ccptnum][1]=p->YN[JP1];
        p->ccpoint[p->ccptnum][2]=p->ZN[KP1];
        ...
        && cl[6]<=0 && cl[9]<=0 && cl[4]<=0 && cl[6]<=0 && cl[7]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XN[IP1];
        p->ccpoint[p->ccptnum][1]=p->YN[JP];
        p->ccpoint[p->ccptnum][2]=p->ZP[KP];
        ...
        && cl[9]<=0 && cl[10]<=0 && cl[4]<=0 && cl[5]<=0 && cl[7]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XN[IP1];
        p->ccpoint[p->ccptnum][1]=p->YN[JP1];
        p->ccpoint[p->ccptnum][2]=p->ZP[KP];
        ...
        && cl[10]<=0 && cl[11]<=0 && cl[4]<=0 && cl[5]<=0 && cl[6]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XN[IP];
        p->ccpoint[p->ccptnum][1]=p->YN[JP1];
        p->ccpoint[p->ccptnum][2]=p->ZP[KP];
        ...
        && cl[8]<=0 && cl[11]<=0 && cl[5]<=0 && cl[6]<=0 && cl[7]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XN[IP];
        p->ccpoint[p->ccptnum][1]=p->YN[JP];
        p->ccpoint[p->ccptnum][2]=p->ZP[KP];
        ...
        && cl[2]<=0 && cl[6]<=0 && cl[3]<=0 && cl[9]<=0 && cl[11]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XN[IP1];
        p->ccpoint[p->ccptnum][1]=p->YP[JP];
        p->ccpoint[p->ccptnum][2]=p->ZN[KP];
        ...
        && cl[2]<=0 && cl[7]<=0 && cl[1]<=0 && cl[9]<=0 && cl[11]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XN[IP];
        p->ccpoint[p->ccptnum][1]=p->YP[JP];
        p->ccpoint[p->ccptnum][2]=p->ZN[KP];
        ...
        && cl[7]<=0 && cl[10]<=0 && cl[1]<=0 && cl[3]<=0 && cl[9]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XN[IP];
        p->ccpoint[p->ccptnum][1]=p->YP[JP];
        p->ccpoint[p->ccptnum][2]=p->ZN[KP1];
        ...
        && cl[6]<=0 && cl[10]<=0 && cl[1]<=0 && cl[3]<=0 && cl[11]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XN[IP1];
        p->ccpoint[p->ccptnum][1]=p->YP[JP];
        p->ccpoint[p->ccptnum][2]=p->ZN[KP1];
        ...
        && cl[6]<=0 && cl[9]<=0 && cl[0]<=0 && cl[2]<=0 && cl[8]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XP[IP];
        p->ccpoint[p->ccptnum][1]=p->YN[JP1];
        p->ccpoint[p->ccptnum][2]=p->ZN[KP1];
        ...
        && cl[5]<=0 && cl[9]<=0 && cl[0]<=0 && cl[2]<=0 && cl[10]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XP[IP];
        p->ccpoint[p->ccptnum][1]=p->YN[JP];
        p->ccpoint[p->ccptnum][2]=p->ZN[KP1];
        ...
        && cl[1]<=0 && cl[5]<=0 && cl[2]<=0 && cl[8]<=0 && cl[10]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XP[IP];
        p->ccpoint[p->ccptnum][1]=p->YN[JP];
        p->ccpoint[p->ccptnum][2]=p->ZN[KP];
        ...
        && cl[1]<=0 && cl[6]<=0 && cl[0]<=0 && cl[8]<=0 && cl[10]<=0)
        {
        p->ccpoint[p->ccptnum][0]=p->XP[IP];
        p->ccpoint[p->ccptnum][1]=p->YN[JP1];
        p->ccpoint[p->ccptnum][2]=p->ZN[KP];
