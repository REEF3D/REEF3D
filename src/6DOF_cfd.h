...
public:
    ...
    void start_cfd(lexer*,fdm*,ghostcell*,vrans*,vector<net*>&,int,field&,field&,field&,field&,field&,field&,bool) override;
    void start_nhflow(lexer*,fdm_nhf*,ghostcell*,vrans*,vector<net*>&,int,double*,double*,double*,double*,double*,double*,slice&,slice&,bool) override;
    ...
    void initialize(lexer*, fdm*, ghostcell*, vector<net*>&) override;
    void initialize(lexer*, fdm2D*, ghostcell*, vector<net*>&) override;
    void initialize(lexer*, fdm_nhf*, ghostcell*, vector<net*>&) override;
