...
// re.open file
	...
	if(!file)
	std::cout<<std::endl<<("no '6DOF_motion.dat' file found")<<endl<<endl;
...
void sixdof_forcesext_file::forcesext_rot(lexer*, Eigen::Vector3d&, Eigen::Vector3d&, Eigen::Vector4d&, Eigen::Matrix<double, 3, 4>&,  Eigen::Matrix3d&){
    return;
}
