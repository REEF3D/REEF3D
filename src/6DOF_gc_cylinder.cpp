...
void sixdof_gc::cylinder_x(lexer *p, fdm *a, ghostcell *pgc, int id)
{
	double U,ds,phi;
...
void sixdof_gc::cylinder_y(lexer *p, fdm *a, ghostcell *pgc, int id)
{
	double U,ds,phi;
...
void sixdof_gc::cylinder_z(lexer *p, fdm *a, ghostcell *pgc, int id)
{
	double U,ds,phi;
