...
void bicgstab_ijk_2D::start(lexer* p,fdm* a, ghostcell* pgc, field &f, vec& rhsvec, int var, int gcv, double stop_crit)
{
	p->preconiter=0;
...
void bicgstab_ijk_2D::startM(lexer* p,fdm* a, ghostcell* pgc, field &f, vec& rhsvec, matrix_diag& M, int var, int gcv, double stop_crit)
{
}
...
void bicgstab_ijk_2D::solve(lexer* p,fdm* a, ghostcell* pgc, vec& rhsvec, int var, int gcv, int &solveriter, int maxiter, double stop_crit)
{
	solveriter=0;
	residual = 1.0e9;
