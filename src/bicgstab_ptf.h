...
#ifndef BICGSTAB_PTF_H_
#define BICGSTAB_PTF_H_


class bicgstab_ptf : public solver_ptf, public increment
{
public:
	bicgstab_ptf(lexer*,fdm_ptf*,ghostcell*);

	virtual ~bicgstab_ptf();
	...
	virtual void setup(lexer*,fdm_ptf*, ghostcell*,int);
	...
	void matvec_std(lexer*,fdm_ptf*, double*, double*);
