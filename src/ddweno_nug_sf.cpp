...
void ddweno_nug_sf::iqmin(vec& f, cpt &C)
{
...
void ddweno_nug_sf::jqmin(vec& f, cpt &C)
{
...
void ddweno_nug_sf::kqmin(vec& f, cpt &C)
{
...
void ddweno_nug_sf::iqmax(vec& f, cpt &C)
{
...
void ddweno_nug_sf::jqmax(vec& f, cpt &C)
{
...
void ddweno_nug_sf::kqmax(vec& f, cpt &C)
{
