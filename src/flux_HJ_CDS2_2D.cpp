...
void flux_HJ_CDS2_2D::u_flux(fdm* a,int ipol, field& uvel, double &uflux1, double &uflux2)
{
	if(ipol==1)
	{
	uflux1 = uvel(i,j,k);
...
void flux_HJ_CDS2_2D::v_flux(fdm* a,int ipol,field&vvel, double &vflux1, double &vflux2)
{
	vflux1 = 0.0;
}

void flux_HJ_CDS2_2D::w_flux(fdm* a,int ipol,field& wvel, double &wflux1, double &wflux2)
{
