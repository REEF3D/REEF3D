...
// Store extragcb in gcb vec
    ...
    VLOOP
    {
        ...
        if(p->flag2[Im1JK]==TOPO_FLAG)
        p->gcb2[count][4]=5;

        if(p->flag2[Im1JK]==OBJ_FLAG)
        p->gcb2[count][4]=21;
        
        if(p->flag2[Im1JK]==SOLID_FLAG)
        p->gcb2[count][4]=22;
        
        if(p->flag2[Im1JK]==FLT_FLAG)
        p->gcb2[count][4]=41;
        ++count;
        }
        ...
        if(p->flag2[IJm1K]==TOPO_FLAG)
        p->gcb2[count][4]=5;

        if(p->flag2[IJm1K]==OBJ_FLAG)
        p->gcb2[count][4]=21;
        
        if(p->flag2[IJm1K]==SOLID_FLAG)
        p->gcb2[count][4]=22;
        
        if(p->flag2[IJm1K]==FLT_FLAG)
        p->gcb2[count][4]=41;    
        ++count;
        }
        ...
        if(p->flag2[IJp1K]==SOLID_FLAG)
        p->gcb2[count][4]=22;
        
        if(p->flag2[IJp1K]==FLT_FLAG)
        p->gcb2[count][4]=41;
        ++count;
        }
        ...
        if(p->flag2[Ip1JK]==SOLID_FLAG)
        p->gcb2[count][4]=22;
        
        if(p->flag2[Ip1JK]==FLT_FLAG)
        p->gcb2[count][4]=41;
        ++count;
        }
        ...
        if(p->flag2[IJKm1]==TOPO_FLAG)
        p->gcb2[count][4]=5;

        if(p->flag2[IJKm1]==OBJ_FLAG)
        p->gcb2[count][4]=21;
        
        if(p->flag2[IJKm1]==SOLID_FLAG)
        p->gcb2[count][4]=22;

        if(p->flag2[IJKm1]==FLT_FLAG)
        p->gcb2[count][4]=41;
        ++count;
        }
        ...
        if(p->flag2[IJKp1]==SOLID_FLAG)
        p->gcb2[count][4]=22;
        
        if(p->flag2[IJKp1]==FLT_FLAG)
        p->gcb2[count][4]=41;
        ++count;
        }
    }
    ...
    k=p->gcpara1[q][2];
        ...
        if(p->flag2[IJK]==SOLID_FLAG)
        p->gcb2[count][4]=22;
		
		if(p->flag2[IJK]==FLT_FLAG)
        p->gcb2[count][4]=41;
        ++count;
        }
    }
