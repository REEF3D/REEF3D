...
#ifndef HYPRE_AIJ_PTF_H_
#define HYPRE_AIJ_PTF_H_

class hypre_aij_ptf : public solver_ptf, public increment
{
public:

	hypre_aij_ptf(lexer*,fdm_ptf*,ghostcell*);
	virtual ~hypre_aij_ptf();
	...
	void solve(lexer*,fdm_ptf*, ghostcell*, vec&, vec&, int, int, int&);
	...
	void fillbackvec(lexer*,fdm_ptf*,field&,vec&,int);
    
    
    void make_grid(lexer*,ghostcell*);
    void delete_grid(lexer*,ghostcell*);
	void fill_matrix_7p(lexer*,fdm_ptf*, ghostcell*,field&);
    void fill_matrix_13p(lexer*,fdm_ptf*, ghostcell*,field&);
    void fill_matrix_19p(lexer*,fdm_ptf*, ghostcell*,field&);
