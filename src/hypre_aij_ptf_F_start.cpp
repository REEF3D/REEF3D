...
void hypre_aij_ptf::startF(lexer* p, ghostcell* pgc, double *f, vec& rhsvec, matrix_diag &M, int var)
{     
    double *xvec;
...
void hypre_aij_ptf::fillbackvec_F(lexer *p, double *f, double *xvec, int var)
{
...
void hypre_aij_ptf::fillbackvec_F_v2(lexer *p, double *f, double *xvec, int var)
{
