...
void hypre_sstruct::start(lexer* p,fdm* a, ghostcell* pgc, field &f, vec& rhsvec, int var, int gcv, double stop_crit)
{
    if(var>=1 && var<=4)
...
void hypre_sstruct::startM(lexer* p,fdm* a, ghostcell* pgc, field &f, vec& rhsvec, matrix_diag& M, int var, int gcv, double stop_crit)
{
}
