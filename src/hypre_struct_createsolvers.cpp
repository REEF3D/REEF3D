...
void hypre_struct::create_solver5(lexer* p, ghostcell* pgc)
{
    ...
    // FNPF
    else if(precon_type==11 && p->A10==3)
    {
    ...
    // NHFLOW
    else if(precon_type==11 && p->A10==5)
    {
        HYPRE_StructPFMGCreate(pgc->mpi_comm, &precond);
        HYPRE_StructPFMGSetMaxIter(precond, 1);
        HYPRE_StructPFMGSetTol(precond, 1.0e-06);
    ...
    // CFD
    else if(precon_type==11 && p->A10==6)
    {
        HYPRE_StructPFMGCreate(pgc->mpi_comm, &precond);
        HYPRE_StructPFMGSetMaxIter(precond, 1);
    ...
    else if(precon_type==11 && p->A10!=3 && p->A10!=5 && p->A10!=6)
    {
        HYPRE_StructPFMGCreate(pgc->mpi_comm, &precond);
        HYPRE_StructPFMGSetMaxIter(precond, 1);
        HYPRE_StructPFMGSetTol(precond, 0.0);
...
void hypre_struct::delete_solver5(lexer* p,ghostcell* pgc)
{
    ...
    HYPRE_StructBiCGSTABDestroy(solver);
    else if(solve_type==15 || solve_type==16 || solve_type==17)
