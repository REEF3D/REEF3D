...
void hypre_struct_ptf::make_grid(lexer* p, ghostcell* pgc)
{
...
void hypre_struct_ptf::make_grid_2Dvert(lexer* p,ghostcell* pgc)
{    
    // grid
    ilower[0] = p->origin_i;
    ilower[1] = p->origin_k;
...
void hypre_struct_ptf::make_grid_15pt(lexer* p, ghostcell* pgc)
{    
    // grid
    ilower[0] = p->origin_i;
    ilower[1] = p->origin_j;
...
void hypre_struct_ptf::make_grid_2D_9pt(lexer* p,ghostcell* pgc)
{    
    // grid
    ilower[0] = p->origin_i;
    ilower[1] = p->origin_k;
