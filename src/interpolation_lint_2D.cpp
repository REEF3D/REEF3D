...
double interpolation::lint7V_2D(double *f, int& i,int& j, int& k, double wa, double wb, double wc1, double wc2)
{
    v1=v2=v3=v4=0.0;
...
double interpolation::lint7V_old_2D(double *f, int& i,int& j, int& k, double wa, double wb, double wc)
{
    v1=v2=v3=v4=0.0;
