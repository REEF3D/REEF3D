...
void  ioflow_gravity::isource_nhflow(lexer *p, fdm_nhf *d, ghostcell *pgc, vrans_nhflow *pvrans)
{
	NLOOP4
	d->rhsvec.V[n]=0.0;
...
void  ioflow_gravity::jsource_nhflow(lexer *p, fdm_nhf *d, ghostcell *pgc, vrans_nhflow *pvrans)
{
	NLOOP4
	d->rhsvec.V[n]=0.0;
...
void  ioflow_gravity::ksource_nhflow(lexer *p, fdm_nhf *d, ghostcell *pgc, vrans_nhflow *pvrans)
{
	NLOOP4
	d->rhsvec.V[n]=0.0;
