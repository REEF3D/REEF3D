...
void iowave::isource_nhflow(lexer *p, fdm_nhf *d, ghostcell *pgc, vrans_nhflow *pvrans)
{
	NLOOP4
	d->rhsvec.V[n]=0.0;
...
void iowave::jsource_nhflow(lexer *p, fdm_nhf *d, ghostcell *pgc, vrans_nhflow *pvrans)
{
	NLOOP4
	d->rhsvec.V[n]=0.0;
...
void iowave::ksource_nhflow(lexer *p, fdm_nhf *d, ghostcell *pgc, vrans_nhflow *pvrans)
{
	NLOOP4
	d->rhsvec.V[n]=0.0;
