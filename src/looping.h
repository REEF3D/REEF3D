...
#define OSOLIDCHECK  if(p->flag4[IJK]==SOLID)
...
#define OSOLIDLOOP ILOOP JLOOP KLOOP OSOLIDCHECK
...
#define OFLUIDCHECK  if(p->flag4[IJK]>0)
...
#define OFLUIDLOOP ILOOP JLOOP KLOOP OFLUIDCHECK  
