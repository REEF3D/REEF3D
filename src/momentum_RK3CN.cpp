...
void momentum_RK3CN::start(lexer *p, fdm *a, ghostcell *pgc, vrans *pvrans)
{	
//        cout << "momentum_RK3CN::start" << endl;
...
//--------------------------------------------------------
	...
	pdiff->diff_u(p,a,pgc,psolv,urk1,a->u,a->v,a->w,8.0/15.0);
	...
	pconvec->start(p,a,a->v,2,a->u,a->v,a->w);
        ...
        pdiff->diff_v(p,a,pgc,psolv,vrk1,a->u,a->v,a->w,8.0/15.0);
	...
	pdiff->diff_w(p,a,pgc,psolv,wrk1,a->u,a->v,a->w,8.0/15.0);
...
//--------------------------------------------------------
	...
	pdiff->diff_u(p,a,pgc,psolv,urk2,urk1,vrk1,wrk1,2.0/15.0);
	...
	pdiff->diff_v(p,a,pgc,psolv,vrk2,urk1,vrk1,wrk1,2.0/15.0);
	...
	pdiff->diff_w(p,a,pgc,psolv,wrk2,urk1,vrk1,wrk1,2.0/15.0);
...
//--------------------------------------------------------
	...
	pdiff->diff_u(p,a,pgc,psolv,a->u,urk2,vrk2,wrk2,1.0/3.0);
	...
	pdiff->diff_v(p,a,pgc,psolv,a->v,urk2,vrk2,wrk2,1.0/3.0);
	...
	pdiff->diff_w(p,a,pgc,psolv,a->w,urk2,vrk2,wrk2,1.0/3.0);
...
void momentum_RK3CN::timecheck(lexer *p,fdm *a,ghostcell *pgc,field &u,field &v,field &w)
{
}
