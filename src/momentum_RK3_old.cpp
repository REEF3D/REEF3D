...
momentum_RK3_old::momentum_RK3_old(lexer *p, fdm *a, convection *pconvection, diffusion *pdiffusion, pressure* ppressure, poisson* ppoisson,
...
void momentum_RK3_old::start(lexer *p, fdm *a, ghostcell *pgc, vrans *pvrans)
{	
...
//--------------------------------------------------------
	...
	pdiff->diff_u(p,a,pgc,psolv,urk1,vrk1,wrk1,1.0);
	...
	pdiff->diff_v(p,a,pgc,psolv,urk1,vrk1,wrk1,1.0);
	...
	pdiff->diff_w(p,a,pgc,psolv,urk1,vrk1,wrk1,1.0);
...
//--------------------------------------------------------
	...
	pdiff->diff_u(p,a,pgc,psolv,urk2,vrk2,wrk2,1.0);
	...
	pdiff->diff_v(p,a,pgc,psolv,urk2,vrk2,wrk2,1.0);
	...
	pdiff->diff_w(p,a,pgc,psolv,urk2,vrk2,wrk2,1.0);
...
void momentum_RK3_old::irhs(lexer *p, fdm *a, ghostcell *pgc, field &f, field &uvel, field &vvel, field &wvel, double alpha)
{
	n=0;
	ULOOP
	{
...
void momentum_RK3_old::jrhs(lexer *p, fdm *a, ghostcell *pgc, field &f, field &uvel, field &vvel, field &wvel, double alpha)
{
	n=0;
	VLOOP
	{
...
void momentum_RK3_old::krhs(lexer *p, fdm *a, ghostcell *pgc, field &f, field &uvel, field &vvel, field &wvel, double alpha)
{
	n=0;
	WLOOP
	{
...
void momentum_RK3_old::vtimesave(lexer *p, fdm *a, ghostcell *pgc)
{
}

void momentum_RK3_old::wtimesave(lexer *p, fdm *a, ghostcell *pgc)
{
}
