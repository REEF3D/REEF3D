...
void multiphase_f::ini(lexer *p, fdm *a, ghostcell *pgc, ioflow *pflow)
{
...
// LS1
    ...
    for(qn=0;qn<p->F378;++qn)
    {
        ...
        LOOP
        {
            r = sqrt(pow(p->XP[IP]-xc,2.0)+pow(p->YP[JP]-yc,2.0)+pow(p->ZP[KP]-zc,2.0));
