...
void nhflow_concentration_io::ini(lexer* p, fdm_nhf *d, ghostcell* pgc, nhflow_concentration *pconcentration)
{
    /*
...
double nhflow_concentration_io::fx(double x1, double z1, double x2, double z2, double x)
{
	double f;
...
double nhflow_concentration_io::fz(double x1, double z1, double x2, double z2, double z)
{
	double f;
