...
#ifndef NHFLOW_FSF_RK_NW_H_
#define NHFLOW_FSF_RK_NW_H_

class nhflow_fsf_rk_nw : public nhflow_fsf, public increment
{
public:
    nhflow_fsf_rk_nw(lexer*, fdm_nhf*, ghostcell*,ioflow*,patchBC_interface*);
	virtual ~nhflow_fsf_rk_nw();
