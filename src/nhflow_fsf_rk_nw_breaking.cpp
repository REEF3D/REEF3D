...
void nhflow_fsf_rk_nw::breaking(lexer* p, fdm_nhf* d, ghostcell* pgc, slice& eta, slice &eta_n, double alpha)
{   
...
void nhflow_fsf_rk_nw::filter(lexer *p, fdm_nhf *d, ghostcell *pgc, slice &f)
{
