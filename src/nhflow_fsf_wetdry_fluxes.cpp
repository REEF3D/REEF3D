...
void nhflow_fsf_f::wetdry_fluxes(lexer* p, fdm_nhf* d, ghostcell* pgc, slice &WL, double *U, double *V, double *W, double *UH, double *VH, double *WH)
{
   ...
   { 
    ...
    ULOOP
    {
        if((p->wet[IJ]==1 && p->wet[Ip1J]==0) || (p->DF[IJK]==1 && p->DF[Ip1JK]==-1))
        {
        d->Un[IJK] = 0.0;
        d->Vn[IJK] = 0.0;
        d->Wn[IJK] = 0.0;
        ...
        if((p->wet[IJ]==0 && p->wet[Ip1J]==1)  || (p->DF[IJK]==-1 && p->DF[Ip1JK]==1))
        {
        d->Un[IJK] = 0.0;
        d->Vn[IJK] = 0.0;
        d->Wn[IJK] = 0.0;
        ...
        if((p->wet[IJ]==0 && p->wet[Ip1J]==0)  || (p->DF[IJK]==-1 && p->DF[Ip1JK]==-1))
        {
        d->Un[IJK] = 0.0;
        d->Vn[IJK] = 0.0;
        d->Wn[IJK] = 0.0;
    ...
    VLOOP
    {
        ...
        if((p->wet[IJ]==1 && p->wet[IJp1]==0) || (p->DF[IJK]==1 && p->DF[IJp1K]==-1))
        {
        d->Uw[IJK] = 0.0;
        d->Vw[IJK] = 0.0;
        d->Ww[IJK] = 0.0;
        ...
        if((p->wet[IJ]==0 && p->wet[IJp1]==1) || (p->DF[IJK]==-1 && p->DF[IJp1K]==1))
        {
        d->Uw[IJK] = 0.0;
        d->Vw[IJK] = 0.0;
        d->Ww[IJK] = 0.0;
        ...
        if((p->wet[IJ]==0 && p->wet[IJp1]==0) || (p->DF[IJK]==-1 && p->DF[IJp1K]==-1))
        {
        d->Uw[IJK] = 0.0;
        d->Vw[IJK] = 0.0;
        d->Ww[IJK] = 0.0;
