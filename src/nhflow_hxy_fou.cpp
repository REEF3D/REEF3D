...
nhflow_hxy_fou::nhflow_hxy_fou(lexer* p, patchBC_interface *ppBC) : nhflow_hxy_flux(p)
{
    pBC = ppBC;
...
nhflow_hxy_fou::~nhflow_hxy_fou()
{
}

void nhflow_hxy_fou::start(lexer* p, slice& hx, slice& hy, slice& depth, int *wet, slice& eta, slice& uvel, slice& vvel)
{
	double eps=1.0e-7;
	
    SLICELOOP1
	{
	u_flux(4,uvel,ivel1,ivel2);
