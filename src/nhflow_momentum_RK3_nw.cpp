...
nhflow_momentum_RK3_nw::nhflow_momentum_RK3_nw(lexer *p, fdm_nhf *d, ghostcell *pgc)
...
nhflow_momentum_RK3_nw::~nhflow_momentum_RK3_nw()
{
}

void nhflow_momentum_RK3_nw::start(lexer *p, fdm_nhf *d, ghostcell *pgc, ioflow *pflow, nhflow_convection *pconvec, diffusion *pdiff, 
...
void nhflow_momentum_RK3_nw::irhs(lexer *p, fdm_nhf *d, ghostcell *pgc)
{
    /*
	n=0;
	LOOP
...
void nhflow_momentum_RK3_nw::jrhs(lexer *p, fdm_nhf *d, ghostcell *pgc)
{
    /*
	n=0;
	VLOOP
...
void nhflow_momentum_RK3_nw::krhs(lexer *p, fdm_nhf *d, ghostcell *pgc)
{
    /*
	n=0;
	WLOOP
...
void nhflow_momentum_RK3_nw::clearrhs(lexer *p, fdm_nhf *d, ghostcell *pgc)
{
...
void nhflow_momentum_RK3_nw::inidisc(lexer *p, fdm_nhf *d, ghostcell *pgc, nhflow_fsf *pfsf)
{
