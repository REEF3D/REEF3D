...
#ifndef NHFLOW_MOMENTUM_RK3_NW_H_
#define NHFLOW_MOMENTUM_RK3_NW_H_

class nhflow_momentum_RK3_nw : public nhflow_momentum, public bcmom, public nhflow_sigma
{
public:
	nhflow_momentum_RK3_nw(lexer*, fdm_nhf*, ghostcell*);
	virtual ~nhflow_momentum_RK3_nw();
