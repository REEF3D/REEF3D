...
class density;
class solver;
class nhflow_poisson_c;
class patchBC_interface;

using namespace std;

#ifndef NHFLOW_PJM_C_H_
#define NHFLOW_PJM_C_H_

class nhflow_pjm_c : public nhflow_pressure, public increment
{

public:

	nhflow_pjm_c(lexer*, fdm_nhf*, ghostcell*,patchBC_interface*);
	virtual ~nhflow_pjm_c();
