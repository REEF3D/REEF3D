...
class density;
class solver;
class nhflow_poisson_cf;
class patchBC_interface;

using namespace std;

#ifndef NHFLOW_PJM_CF_H_
#define NHFLOW_PJM_CF_H_

class nhflow_pjm_cf : public nhflow_pressure, public increment
{

public:

	nhflow_pjm_cf(lexer*, fdm_nhf*, ghostcell*,patchBC_interface*);
	virtual ~nhflow_pjm_cf();
