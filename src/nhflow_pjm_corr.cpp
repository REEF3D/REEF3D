...
void nhflow_pjm_corr::upgrad(lexer*p, fdm_nhf *d)
{
    LOOP
    WETDRY
...
void nhflow_pjm_corr::vpgrad(lexer*p,fdm_nhf *d)
{
    LOOP
    WETDRY
...
void nhflow_pjm_corr::wpgrad(lexer*p, fdm_nhf *d)
{
    LOOP
    WETDRY
