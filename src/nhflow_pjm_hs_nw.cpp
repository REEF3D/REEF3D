...
nhflow_pjm_hs_nw::nhflow_pjm_hs_nw(lexer* p, fdm_nhf *d, patchBC_interface *ppBC)
{
    pBC = ppBC;
...
nhflow_pjm_hs_nw::~nhflow_pjm_hs_nw()
{
}

void nhflow_pjm_hs_nw::start(lexer*p, fdm_nhf *d, solver* psolv, ghostcell* pgc, ioflow *pflow, double *U, double *V, double *W, double alpha)
{
}

void nhflow_pjm_hs_nw::ucorr(lexer* p, fdm_nhf *d, double *U, double alpha)
{	
}

void nhflow_pjm_hs_nw::vcorr(lexer* p, fdm_nhf *d, double *U, double alpha)
{	 
}

void nhflow_pjm_hs_nw::wcorr(lexer* p, fdm_nhf *d, double *W, double alpha)
{
}
 
void nhflow_pjm_hs_nw::rhs(lexer *p, fdm_nhf *d, ghostcell *pgc, double *U, double *V, double *W, double alpha)
{
}
 
void nhflow_pjm_hs_nw::vel_setup(lexer *p, fdm_nhf *d, ghostcell *pgc, double *U, double *V, double *W, double alpha)
{
}

void nhflow_pjm_hs_nw::upgrad(lexer*p, fdm_nhf *d, slice &eta, slice &eta_n)
{
...
void nhflow_pjm_hs_nw::vpgrad(lexer*p, fdm_nhf *d, slice &eta, slice &eta_n)
{
    if(p->A521==1 && p->A540==1)
    LOOP
    WETDRY
...
void nhflow_pjm_hs_nw::wpgrad(lexer*p, fdm_nhf *d, slice &eta, slice &eta_n)
{
}


double nhflow_pjm_hs_nw::limiter(double v1, double v2)
{
