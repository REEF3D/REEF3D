...
#ifndef NHFLOW_PJM_NW_H_
#define NHFLOW_PJM_NW_H_

class nhflow_pjm_nw : public nhflow_pressure, public increment
{

public:

	nhflow_pjm_nw(lexer*, fdm_nhf*, ghostcell*,patchBC_interface*);
	virtual ~nhflow_pjm_nw();
