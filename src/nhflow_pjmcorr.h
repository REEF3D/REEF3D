...
#ifndef NHFLOW_PJMCORR_H_
#define NHFLOW_PJMCORR_H_

class nhflow_pjmcorr : public nhflow_pressure, public increment
{
...
public:
	...
	virtual void upgrad(lexer*,fdm_nhf*,double*,slice&);
