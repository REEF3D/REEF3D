...
#ifndef NHFLOW_RECONSTRUCT_VOID_H_
#define NHFLOW_RECONSTRUCT_VOID_H_
...
class nhflow_reconstruct_void : public nhflow_reconstruct, public nhflow_gradient
{
public:
	nhflow_reconstruct_void(lexer*,patchBC_interface*);
	virtual ~nhflow_reconstruct_void();
