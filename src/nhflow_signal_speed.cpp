                                        ...
                                        slice &Ds,slice &Dn, slice &De, slice &Dw)
{
    ...
    if((p->wet[IJ]==1 && p->wet[Ip1J]==1) && ((p->DF[IJK]==1 && p->DF[Ip1JK]==1)) || p->A525==1)
    {
    ...
    if((p->wet[IJ]==0 && p->wet[Ip1J]==1) || (p->DF[IJK]<0 && p->DF[Ip1JK]==1 && p->A525==0))  // left dry
    {
    ...
    if((p->wet[IJ]==1 && p->wet[Ip1J]==0) || (p->DF[IJK]==1 && p->DF[Ip1JK]<0 && p->A525==0)) // right dry
    {
    d->Ss[IJK] = Us[IJK] - Cs;
    d->Sn[IJK] = Us[IJK] + Cs;
    d->SSx[IJK] = d->Sn[IJK];
    ...
    if((p->wet[IJ]==0 && p->wet[Ip1J]==0)  || (p->DF[IJK]<0 && p->DF[Ip1JK]<0 && p->A525==0))
    {
    d->Ss[IJK] = 0.0;
    d->Sn[IJK] = 0.0;
    d->SSx[IJK] = 0.0;
    ...
    if((p->wet[IJ]==1 && p->wet[IJp1]==1) && ((p->DF[IJK]==1 && p->DF[IJp1K]==1) || p->A525==1))
    {
    ...
    if((p->wet[IJ]==0 && p->wet[IJp1]==1) || (p->DF[IJK]<0 && p->DF[IJp1K]==1 && p->A525==0))
    {
    ...
    if((p->wet[IJ]==1 && p->wet[IJp1]==0) || (p->DF[IJK]==1 && p->DF[IJp1K]<0 && p->A525==0))
    {
    d->Se[IJK] = Ve[IJK] -     Ce;
    ...
    if((p->wet[IJ]==0 && p->wet[IJp1]==0) || (p->DF[IJK]<0 && p->DF[IJp1K]<0 && p->A525==0))
    {
    d->Se[IJK] = 0.0;
    d->Sw[IJK] = 0.0;
    d->SSy[IJK] = 0.0;
