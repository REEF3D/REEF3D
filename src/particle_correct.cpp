...
void particle_f::correct(lexer* p, fdm* a, ghostcell* pgc, ioflow *pflow)
{
    corrected=0;
...
void particle_f::parcorr(lexer *p,fdm* a,ioflow *pflow,double sign,double* f,int i1,int j1,int k1,int i0, int j0, int k0)
{
    int check=0;
...
void particle_f::finalcorr(lexer* p, fdm* a, ghostcell* pgc)
{
...
void particle_f::inicorr(lexer* p, fdm* a, ghostcell* pgc)
{
    LOOP
    {
