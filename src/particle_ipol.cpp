...
double particle_f::phipol(lexer *p,fdm* a, double& xp, double& yp, double& zp)
{
    ii=i;
    jj=j;
    kk=k;
...
double particle_f::upol(lexer *p,fdm* a, double& xp, double& yp, double& zp)
{
    ii=i;
    jj=j;
    kk=k;
...
double particle_f::vpol(lexer *p,fdm* a, double& xp, double& yp, double& zp)
{
    ii=i;
    jj=j;
    kk=k;
...
double particle_f::wpol(lexer *p,fdm* a, double& xp, double& yp, double& zp)
{
    ii=i;
    jj=j;
    kk=k;
...
double particle_f::lint(field& f, int& i,int& j, int& k, double wa, double wb, double wc)
{
pip=4;
...
double particle_f::cint(double wx, double f0, double f1, double f2, double f3)
{
    di0 = (f2-f0)*0.5;
    di1 = (f3-f1)*0.5;
    df=(f2-f1);
...
double particle_f::tricubic(lexer *p,fdm* a,field& f, int& i,int& j, int& k, double wx, double wy, double wz)
{
pip=4;
    i0=j0=k0=1;
    i3=j3=k3=2;
