...
void print_porous::box(lexer *p, int rank)
{
...
void print_porous::cylinder_z(lexer *p, int rank)
{
    int vertice_start=vertice_num;
...
void print_porous::wedge_x(lexer *p, int rank)
{
    double xs,ys,zs,xe,ye,ze;
    int vertice_start=vertice_num;
...
void print_porous::wedge_y(lexer *p,int rank)
{
    double xs,ys,zs,xe,ye,ze;
    int vertice_start=vertice_num;
...
void print_porous::plate_x(lexer *p, int rank)
{
...
void print_porous::box_veg(lexer *p, int rank)
{
    double xs,ys,zs,xe,ye,ze;
    int vertice_start=vertice_num;
...
void print_porous::wedge_x_veg(lexer *p, int rank)
{
    double xs,ys,zs,xe,ye,ze;
    int vertice_start=vertice_num;
...
void print_porous::wedge_y_veg(lexer *p, int rank)
{
    double xs,ys,zs,xe,ye,ze;
    int vertice_start=vertice_num;
