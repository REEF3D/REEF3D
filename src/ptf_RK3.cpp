...
void ptf_RK3::start(lexer *p, fdm_ptf *a, ghostcell *pgc, solver *psolv, convection *pconvec, ioflow *pflow, reini *preini, onephase* poneph)
{	
...
void ptf_RK3::ini(lexer *p, fdm_ptf *a, ghostcell *pgc, ioflow *pflow, reini *preini, onephase *poneph)
{	
    pfsfupdate->fsfupdate(p,a,pgc,pflow,poneph,a->eta);
    pfsfupdate->etaloc(p,a,pgc);
