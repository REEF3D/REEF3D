...
{
public:
	ptf_RK3(lexer*, fdm_ptf*, ghostcell*);
	virtual ~ptf_RK3();
    
    virtual void start(lexer*, fdm_ptf*, ghostcell*, solver_ptf*, convection*, ioflow*, reini*,onephase_ptf*);
    virtual void ini(lexer*, fdm_ptf*, ghostcell*, ioflow*, reini*, onephase_ptf*);
