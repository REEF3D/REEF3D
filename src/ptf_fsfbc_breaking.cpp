...
void ptf_fsfbc::breaking(lexer *p, fdm_ptf *a, ghostcell *pgc, slice &eta, slice &eta_n, slice &Fifsf, double alpha)
{
    int ii,jj;
    int count;
...
void ptf_fsfbc::filter(lexer *p, fdm_ptf *a,ghostcell *pgc, slice &f)
{
