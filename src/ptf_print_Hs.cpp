...
ptf_print_Hs::ptf_print_Hs(lexer *p, slice &Hs) : ETAsum(p), ETAmean(p), //DKAF
                                                    ETA2sum(p), ETAvar(p)
{
    NumDT1=0;      
...
ptf_print_Hs::~ptf_print_Hs()
{
}

void ptf_print_Hs::start(lexer *p, ghostcell *pgc, slice &eta, slice &Hs)
{
    // RK3
