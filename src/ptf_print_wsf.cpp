...
ptf_print_wsf::ptf_print_wsf(lexer *p, fdm_ptf *e)
{
...
ptf_print_wsf::~ptf_print_wsf()
{
    wsfout.close();
}

void ptf_print_wsf::height_gauge(lexer *p, fdm_ptf *e, ghostcell *pgc, slice &f)
{
...
void ptf_print_wsf::fill_eta(lexer *p, fdm_ptf *e, ghostcell *pgc, slice &f)
{
    double zval=0.0;
...
void ptf_print_wsf::fill_deta(lexer *p, fdm_ptf *e, ghostcell *pgc, slice &f)
{
    
}
    
void ptf_print_wsf::fill_Uhorz(lexer *p, fdm_ptf *e, ghostcell *pgc, slice &f)
{
    
}


void ptf_print_wsf::ini_location(lexer *p, fdm_ptf *e)
{
    for(n=0;n<gauge_num;++n)
    {
    iloc[n] = p->posc_i(x[n]); 
...
int ptf_print_wsf::conv(double a)
{
