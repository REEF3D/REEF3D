...
ptf_print_wsf_theory::ptf_print_wsf_theory(lexer *p, fdm_ptf* c, ghostcell *pgc)
{
	gauge_num = p->P50;
	x = p->P50_x;
	y = p->P50_y;
...
ptf_print_wsf_theory::~ptf_print_wsf_theory()
{
    wsfout.close();
}

void ptf_print_wsf_theory::height_gauge(lexer *p, fdm_ptf *e, ghostcell *pgc, ioflow *pflow)
{
