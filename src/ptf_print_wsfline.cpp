...
ptf_print_wsfline::ptf_print_wsfline(lexer *p, fdm_ptf *e, ghostcell *pgc)
{	
	p->Iarray(jloc,p->P52);
...
ptf_print_wsfline::~ptf_print_wsfline()
{
    wsfout.close();
}

void ptf_print_wsfline::start(lexer *p, fdm_ptf *e, ghostcell *pgc, ioflow *pflow, slice &f)
{
...
void ptf_print_wsfline::ini_location(lexer *p, fdm_ptf *e, ghostcell *pgc)
{
    int check,count;
...
void ptf_print_wsfline::sort(double *a, double *b, int *e, int left, int right)
{
...
void ptf_print_wsfline::remove_multientry(lexer *p, double* b, double* c, int *d, int& num)
{
    int oldnum=num;
    double xval=-1.12e23;
...
int ptf_print_wsfline::conv(double a)
{
