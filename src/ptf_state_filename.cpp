...
void ptf_state::filename_single(lexer *p, fdm_ptf *e, ghostcell *pgc, int num)
{
    if(p->P14==0)
    {
...
void ptf_state::filename_continuous(lexer *p, fdm_ptf *e, ghostcell *pgc)
{
    if(p->P14==0)
    {
...
void ptf_state::filename_header(lexer *p, fdm_ptf *e, ghostcell *pgc)
{
    if(p->P14==0)
    {
