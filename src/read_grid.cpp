...
void lexer::read_grid()
{
    ...
    Iarray(gcslparaco1, gcslparaco1_count,3);
    Iarray(gcslparaco2, gcslparaco2_count,3);
    Iarray(gcslparaco3, gcslparaco3_count,3);
    Iarray(gcslparaco4, gcslparaco4_count,3);
