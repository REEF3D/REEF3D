...
public:
    ...
    virtual void name_ParaView_bedload(lexer*, ofstream&, int*, int &);
    ...
    virtual void name_ParaView_bedshear(lexer*, ofstream&, int*, int &);
    ...
    virtual void name_ParaView_parameter1(lexer*, ofstream&, int*, int &);
    ...
    virtual void name_ParaView_parameter2(lexer*, ofstream&, int*, int &);
