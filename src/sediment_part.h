...
private:
    ...
    void offset_ParaView_2D_bedload(lexer*, ghostcell*, ofstream&, int*, int &) override {};
    ...
    void offset_ParaView_2D_bedshear(lexer*, ghostcell*, ofstream&, int*, int &) override {};
    ...
    void offset_ParaView_2D_parameter1(lexer*, ghostcell*, ofstream&, int*, int &) override {};
    ...
    void offset_ParaView_2D_parameter2(lexer*, ghostcell*, ofstream&, int*, int &) override {};
