...
{	        
    ...
    pflow->inflow2D(p,b,pgc,urk1,vrk1,b->bed,b->eta);
...
//--------------------------------------------------------	
	...
	pflow->um_relax(p,pgc,urk1,b->bed,b->eta);
	pflow->vm_relax(p,pgc,vrk1,b->bed,b->eta);
...
//--------------------------------------------------------
	...
	//--------------------------------------------------------
	// pressure
	ppress->start(p,b,pgc,ppoissonsolv,pflow, b->P, b->Q, urk1, vrk1, b->ws, b->eta, 0.5);
