...
void sflow_print_wsfline_y::start(lexer *p, fdm2D *b, ghostcell *pgc, ioflow *pflow, slice &f)
{
    ...
    if(p->mpirank==0)
    {
		...
		{
		if(num<10)
		sprintf(name,"REEF3D-SFLOW-wsfline_y-00000%d.dat",num);

		if(num<100&&num>9)
		sprintf(name,"REEF3D-SFLOW-wsfline_y-0000%d.dat",num);

		if(num<1000&&num>99)
		sprintf(name,"REEF3D-SFLOW-wsfline_y-000%d.dat",num);

		if(num<10000&&num>999)
		sprintf(name,"REEF3D-SFLOW-wsfline_y-00%d.dat",num);

		if(num<100000&&num>9999)
		sprintf(name,"REEF3D-SFLOW-wsfline_y-0%d.dat",num);

		if(num>99999)
		sprintf(name,"REEF3D-SFLOW-wsfline_y-%d.dat",num);
		}
		
		if(p->P14==1)
		{
		if(num<10)
		sprintf(name,"./REEF3D_SFLOW_WSFLINE_Y/REEF3D-SFLOW-wsfline_y-00000%d.dat",num);

		if(num<100&&num>9)
		sprintf(name,"./REEF3D_SFLOW_WSFLINE_Y/REEF3D-SFLOW-wsfline_y-0000%d.dat",num);

		if(num<1000&&num>99)
		sprintf(name,"./REEF3D_SFLOW_WSFLINE_Y/REEF3D-SFLOW-wsfline_y-000%d.dat",num);

		if(num<10000&&num>999)
		sprintf(name,"./REEF3D_SFLOW_WSFLINE_Y/REEF3D-SFLOW-wsfline_y-00%d.dat",num);

		if(num<100000&&num>9999)
		sprintf(name,"./REEF3D_SFLOW_WSFLINE_Y/REEF3D-SFLOW-wsfline_y-0%d.dat",num);

		if(num>99999)
		sprintf(name,"./REEF3D_SFLOW_WSFLINE_Y/REEF3D-SFLOW-wsfline_y-%d.dat",num);
		}
