...
#ifndef SOLVER_VOID_PTF_H_
#define SOLVER_VOID_PTF_H_

class solver_void_ptf : public solver_ptf
{
public:

	solver_void_ptf(lexer*,fdm_ptf*,ghostcell*);
	virtual ~solver_void_ptf();
