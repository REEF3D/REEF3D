...
class vtk3D
{
    public:
        ...
        virtual void fileName(char*, char*, int&, int&)=0;
        virtual void parallelFileName(char*, char*, int&)=0;
        ...
        virtual void endingParallel(std::ofstream&, char*, int&, int&)=0;
    protected:
