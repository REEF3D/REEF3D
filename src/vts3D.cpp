...
void vts3D::structureWrite(lexer *p, fdm*, std::ostream &result)
{
    float ffn;
    int iin;
...
void vts3D::structureWrite(lexer *p, fdm_fnpf *c, std::ostream &result)
{
    float ffn;
    int iin;
    double phase;
...
void vts3D::structureWrite(lexer *p, fdm_nhf *d, std::ostream &result)
{
    float ffn;
    int iin;
    double zcoor;
