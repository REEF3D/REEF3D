...
#ifndef WENO_FLUX_NUG_DIR_H_
#define WENO_FLUX_NUG_DIR_H_

using namespace std;

class weno_flux_nug_dir : public convection, public weno_nug_func
{
public:
	weno_flux_nug_dir(lexer*);
	virtual ~weno_flux_nug_dir();

	virtual void start(lexer*,fdm*,field&,int,field&,field&,field&);

private:
    double aij_x(lexer*, fdm*, field&, int,field&,field&,field&,double*,double*,double*);
    double aij_y(lexer*, fdm*, field&, int,field&,field&,field&,double*,double*,double*);
    double aij_z(lexer*, fdm*, field&, int,field&,field&,field&,double*,double*,double*);
