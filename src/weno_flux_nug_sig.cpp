...
weno_flux_nug_sig::weno_flux_nug_sig(lexer* p):weno_nug_func(p)
{
    if(p->B269==0)
    {
        if(p->D11==1)
...
weno_flux_nug_sig::~weno_flux_nug_sig()
{
}

void weno_flux_nug_sig::start(lexer* p, fdm* a, field& b, int ipol, field& uvel, field& vvel, field& wvel)
{
    uf=vf=wf=0;
...
double weno_flux_nug_sig::aij(lexer* p,fdm* a,field& b,int ipol, field& uvel, field& vvel, field& wvel, double *DX,double *DY, double *DZ)
{
        // convective flux
...
double weno_flux_nug_sig::fx(lexer *p,fdm *a, field& b, field& uvel, int ipol, double advec)
{
    grad = 0.0;
...
double weno_flux_nug_sig::fy(lexer *p,fdm *a, field& b, field& vvel, int ipol, double advec)
{
    grad = 0.0;
...
double weno_flux_nug_sig::fz(lexer *p,fdm *a, field& b, field& wvel, int ipol, double advec)
{
    grad = 0.0;
...
void weno_flux_nug_sig::iqmin(lexer *p, field& f, field& uvel, int ipol)
{	
	q1 = f(i-2,j,k);
	q2 = f(i-1,j,k);
	q3 = f(i,j,k);
...
void weno_flux_nug_sig::jqmin(lexer *p, field& f, field& vvel, int ipol)
{
	q1 = f(i,j-2,k);
	q2 = f(i,j-1,k);
	q3 = f(i,j,k);
...
void weno_flux_nug_sig::kqmin(lexer *p, field& f, field& wvel, int ipol)
{
	q1 = f(i,j,k-2);
	q2 = f(i,j,k-1);
	q3 = f(i,j,k);
...
void weno_flux_nug_sig::iqmax(lexer *p, field& f, field& uvel, int ipol)
{
    q1 = f(i-1,j,k);
	q2 = f(i,j,k);
	q3 = f(i+1,j,k);
...
void weno_flux_nug_sig::jqmax(lexer *p, field& f, field& vvel, int ipol)
{
	q1 = f(i,j-1,k);
	q2 = f(i,j,k);
	q3 = f(i,j+1,k);
...
void weno_flux_nug_sig::kqmax(lexer *p, field& f, field& wvel, int ipol)
{
	q1 = f(i,j,k-1);
	q2 = f(i,j,k);
	q3 = f(i,j,k+1);
