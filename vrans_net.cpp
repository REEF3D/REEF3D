...
{ 
    ...
    const vector<Eigen::Vector3d>& lagrangePoints = ppnet->getLagrangePoints();
    const vector<Eigen::Vector3d>& lagrangeForces = ppnet->getLagrangeForces();
...
{ 
    ...
    const vector<Eigen::Vector3d>& collarPoints = ppnet->getCollarPoints();
    ...
    vector<Eigen::Vector3d> collarVel = ppnet->getCollarVel();
