...
wallin::wallin(lexer* p, fdm* a) : strain(p,a),rs11(p),rs22(p),rs33(p),rs12(p),rs13(p),rs23(p),
...
void wallin::isource(lexer *p, fdm* a)
{
	ULOOP
	{
...
void wallin::jsource(lexer *p, fdm* a)
{
	VLOOP
	{
...
void wallin::ksource(lexer *p, fdm* a)
{
	WLOOP
	{
