...
void wallin_IM2::start(fdm* a, lexer* p, discrete* pdisc, diffusion* pdiff,solver* psolv, ghostcell* pgc, ioflow* pflow)
{
	kepsilon_IM2::start(a,p,pdisc,pdiff,psolv,pgc,pflow);
