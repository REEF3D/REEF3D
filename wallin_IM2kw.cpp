...
void wallin_IM2kw::start(fdm* a, lexer* p, discrete* pdisc, diffusion* pdiff,solver* psolv, ghostcell* pgc, ioflow* pflow)
{
	komega_IM2::start(a,p,pdisc,pdiff,psolv,pgc,pflow);
