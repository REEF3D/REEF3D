...
void wallin_RK3kw::start(fdm* a, lexer* p, convection* pconvec, diffusion* pdiff,solver* psolv, ghostcell* pgc, ioflow* pflow)
{
	komega_RK3::start(a,p,pconvec,pdiff,psolv,pgc,pflow);
