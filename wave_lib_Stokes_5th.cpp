...
double wave_lib_Stokes_5th::wave_horzvel(lexer *p, double x, double y, double z)
{
    ...
    vel = c0*sqrt(9.81/wk)
         *((eps*a11 + pow(eps,3.0)*a31 + pow(eps,5.0)*a51)*cosh(wk*(wd+z))*cos(T)
         + 2.0*(pow(eps,2.0)*a22 + pow(eps,4.0)*a42)*cosh(2.0*wk*(wd+z))*cos(2.0*T)
         + 3.0*(pow(eps,3.0)*a33 + pow(eps,5.0)*a53)*cosh(3.0*wk*(wd+z))*cos(3.0*T)
         + 4.0*(pow(eps,4.0)*a44)*cosh(4.0*wk*(wd+z))*cos(4.0*T)
         + 5.0*(pow(eps,5.0)*a55)*cosh(5.0*wk*(wd+z))*cos(5.0*T));
...
double wave_lib_Stokes_5th::wave_horzvel_space_sin(lexer *p, double x, double y, double z, int n)
{
    ...
    switch(n)
    {
        case 0: vel = 1.0*c0*sqrt(9.81/wk)*(eps*a11 + pow(eps,3.0)*a31 + pow(eps,5.0)*a51)*cosh(wk*(wd+z))*sin(1.0*T);
        break;
             
        case 1: vel = 2.0*c0*sqrt(9.81/wk)*(pow(eps,2.0)*a22 + pow(eps,4.0)*a42)*cosh(2.0*wk*(wd+z))*sin(2.0*T);
        break;
             
        case 2: vel = 3.0*c0*sqrt(9.81/wk)*(pow(eps,3.0)*a33 + pow(eps,5.0)*a53)*cosh(3.0*wk*(wd+z))*sin(3.0*T);
        break;
             
        case 3: vel = 4.0*c0*sqrt(9.81/wk)*(pow(eps,4.0)*a44)*cosh(4.0*wk*(wd+z))*sin(4.0*T);
        break;
             
        case 4: vel = 5.0*c0*sqrt(9.81/wk)*(pow(eps,5.0)*a55)*cosh(5.0*wk*(wd+z))*sin(5.0*T);
        break;
    }
...
double wave_lib_Stokes_5th::wave_horzvel_space_cos(lexer *p, double x, double y, double z, int n)
{
    ...
    switch(n)
    {
        case 0: vel = 1.0*c0*sqrt(9.81/wk)*(eps*a11 + pow(eps,3.0)*a31 + pow(eps,5.0)*a51)*cosh(wk*(wd+z))*cos(1.0*T);
        break;
             
        case 1: vel = 2.0*c0*sqrt(9.81/wk)*(pow(eps,2.0)*a22 + pow(eps,4.0)*a42)*cosh(2.0*wk*(wd+z))*cos(2.0*T);
        break;
             
        case 2: vel = 3.0*c0*sqrt(9.81/wk)*(pow(eps,3.0)*a33 + pow(eps,5.0)*a53)*cosh(3.0*wk*(wd+z))*cos(3.0*T);
        break;
             
        case 3: vel = 4.0*c0*sqrt(9.81/wk)*(pow(eps,4.0)*a44)*cosh(4.0*wk*(wd+z))*cos(4.0*T);
        break;
             
        case 4: vel = 5.0*c0*sqrt(9.81/wk)*(pow(eps,5.0)*a55)*cosh(5.0*wk*(wd+z))*cos(5.0*T);
        break;
    }
...
double wave_lib_Stokes_5th::wave_w(lexer *p, double x, double y, double z)
{
    ...
    vel = c0*sqrt(9.81/wk)
         *((eps*a11 + pow(eps,3.0)*a31 + pow(eps,5.0)*a51)*sinh(wk*(wd+z))*sin(T)
         + 2.0*(pow(eps,2.0)*a22 + pow(eps,4.0)*a42)*sinh(2.0*wk*(wd+z))*sin(2.0*T)
         + 3.0*(pow(eps,3.0)*a33 + pow(eps,5.0)*a53)*sinh(3.0*wk*(wd+z))*sin(3.0*T)
         + 4.0*(pow(eps,4.0)*a44)*sinh(4.0*wk*(wd+z))*sin(4.0*T)
         + 5.0*(pow(eps,5.0)*a55)*sinh(5.0*wk*(wd+z))*sin(5.0*T));
...
double wave_lib_Stokes_5th::wave_w_space_sin(lexer *p, double x, double y, double z, int n)
{
    ...
    switch(n)
    {
        case 0: vel = 1.0*c0*sqrt(9.81/wk)*(eps*a11 + pow(eps,3.0)*a31 + pow(eps,5.0)*a51)*sinh(wk*(wd+z))*sin(1.0*T);
        break;
         
        case 1: vel = 2.0*c0*sqrt(9.81/wk)*(pow(eps,2.0)*a22 + pow(eps,4.0)*a42)*sinh(2.0*wk*(wd+z))*sin(2.0*T);
        break;
        
        case 2: vel = 3.0*c0*sqrt(9.81/wk)*(pow(eps,3.0)*a33 + pow(eps,5.0)*a53)*sinh(3.0*wk*(wd+z))*sin(3.0*T);
        break;
        
        case 3: vel = 4.0*c0*sqrt(9.81/wk)*(pow(eps,4.0)*a44)*sinh(4.0*wk*(wd+z))*sin(4.0*T);
        break;
        
        case 4: vel = 5.0*c0*sqrt(9.81/wk)*(pow(eps,5.0)*a55)*sinh(5.0*wk*(wd+z))*sin(5.0*T);
        break;
...
double wave_lib_Stokes_5th::wave_w_space_cos(lexer *p, double x, double y, double z, int n)
{
    ...
    switch(n)
    {
        case 0: vel = 1.0*c0*sqrt(9.81/wk)*(eps*a11 + pow(eps,3.0)*a31 + pow(eps,5.0)*a51)*sinh(wk*(wd+z))*cos(1.0*T);
        break;
         
        case 1: vel = 2.0*c0*sqrt(9.81/wk)*(pow(eps,2.0)*a22 + pow(eps,4.0)*a42)*sinh(2.0*wk*(wd+z))*cos(2.0*T);
        break;
        
        case 2: vel = 3.0*c0*sqrt(9.81/wk)*(pow(eps,3.0)*a33 + pow(eps,5.0)*a53)*sinh(3.0*wk*(wd+z))*cos(3.0*T);
        break;
        
        case 3: vel = 4.0*c0*sqrt(9.81/wk)*(pow(eps,4.0)*a44)*sinh(4.0*wk*(wd+z))*cos(4.0*T);
        break;
        
        case 4: vel = 5.0*c0*sqrt(9.81/wk)*(pow(eps,5.0)*a55)*sinh(5.0*wk*(wd+z))*cos(5.0*T);
        break;
...
void wave_lib_Stokes_5th::parameters(lexer *p, ghostcell *pgc)
{
    ...
    a31 = (-4.0 - 20.0*S + 10.0*S*S -13.0*S*S*S)/(8.0*sinh(wk*wd)*C*C*C);

    a33 = (-2.0*S*S + 11*S*S*S)/(8.0*sinh(wk*wd)*C*C*C);
    ...
    a51 = (-1184.0 + 32.0*S + 13232.0*S*S + 21712.0*S*S*S + 20940.0*pow(S,4.0) + 12554.0*pow(S,5.0)
           -500.0*pow(S,6.0) - 3341.0*pow(S,7.0) - 670.0*pow(S,8.0))/(64.0*sinh(wk*wd)*(3.0 + 2.0*S)*(4.0 + S)*pow(C,6.0));

    a53 = (4.0*S + 105.0*pow(S,2.0) + 198.0*pow(S,3.0) - 1376.0*pow(S,4.0) - 1302.0*pow(S,5.0) - 117.0*pow(S,6.0) + 58.0*pow(S,7.0))
          /(32.0*sinh(wk*wd)*(3.0 + 2.0*S)*pow(C,6.0));
    ...
    b42 = ((cosh(wk*wd)/sinh(wk*wd))*(6.0 - 26.0*S - 182.0*S*S - 204.0*S*S*S - 25.0*pow(S,4.0) + 26*pow(S,5.0)))
          /(6.0*(3.0 + 2.0*S)*pow(C,4.0));

    b44 = ((cosh(wk*wd)/sinh(wk*wd))*(24.0 + 92.0*S + 122.0*S*S + 66.0*S*S*S + 67.0*pow(S,4.0) + 34.0*pow(S,5.0)))
    ...
    e2 = (tanh(wk*wd)*(2.0 + 2.0*S + 5.0*S*S))/(4.0*pow(1.0 - S,2.0));
